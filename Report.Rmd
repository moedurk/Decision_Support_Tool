...
##Date
```{r echo = F}
today.date <- cat(format(Sys.Date(), "%b %d %Y"))
```

#Data Input Summary
```{r echo=F}
library(knitr)
if(params$sum.include == 1){
kable(params$summary, digits=1, col.names = c("Nest Count", "Hatches", "Predations", "Abandonments", "Flood/Weather", "UknownFail",
                            "UknownFate", "Other"))
}
